...
public class printallpaths2 {
    ...
    public static void main(String[] args) {
        ...
        printallpaths(src,dest,graph,vis,src+"");
    ...
    public static void printallpaths(int src , int dest , ArrayList<Edge>[] graph,boolean[] vis, String s ){
       if(src==dest){
       ...
       for(int i=0 ; i<temp.size();i++){
        ...
        if(vis[e.nbr]==false){
            printallpaths(e.nbr, dest, graph, vis, s+e.nbr);
        }
